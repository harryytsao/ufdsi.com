              ...
              <div className="w-full px-4">
                <div className="mb-12 text-center">
                  ...
                  <p className="mx-auto max-w-[800px] text-base text-gray-700 dark:text-gray-300">
                    Meet the graduates and past executive boards of the UF Data Science and Informatics student organization who are making an impact in the field of data science and AI.
                  </p>
                </div>
              </div>
