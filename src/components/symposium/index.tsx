  ...
  return (
    <div className="max-w-6xl mx-auto px-4 pt-24 sm:pt-28 pb-8">
      <button
        ...
        className="fixed bottom-4 right-4 sm:bottom-auto sm:right-auto sm:absolute sm:top-0 sm:right-0 p-3 rounded-full bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors shadow-lg z-50"
